...
class AuthRepositoryTest {
  ...
  fun testSignUpSuccess() = runTest {
    runBlocking { authRepository.signUpWithEmailPassword(email, pwd) { success -> assertTrue(success) } }
  }
  ...
  fun testSignInSuccess() = runTest {
    ...
    runBlocking { authRepository.signInWithEmailPassword(email, pwd) { success -> assertTrue(success) } }
