...
class AuthViewModel(): ViewModel() {
    ...
    private fun validateRegisterForm(): Boolean {
        return _signInState.value.emailRegister.isNotBlank() && _signInState.value.passwordRegister.isNotBlank() && _signInState.value.confirmPasswordRegister.isNotBlank()
    }
    ...
    fun signUpWithEmailPassword(context: Context) {
        viewModelScope.launch {
            try {
                ...
                require(_signInState.value.passwordRegister == _signInState.value.confirmPasswordRegister) { "Passwords do not match" }
